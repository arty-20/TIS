...
{!!Form::open(array('url'=>'auxiliar','method'=>'POST','autocomplete'=>'off'))!!}
<div class="form-group">
  <textarea class="form-control" name="comentario" rows="5" placeholder="Aqui va el Comentario">{{ $estudiante[0]->COMENTARIO_AUXILIAR }}</textarea>
  <br>
